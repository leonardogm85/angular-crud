...
@Component({
    ...
    standalone: true,
    imports: [MatCard, MatToolbar, ReactiveFormsModule, MatFormField, MatLabel, MatInput, MatHint, MatError, MatSelect, MatOption, MatIconButton, MatIcon, MatPrefix, MatCardActions, MatButton]
})
